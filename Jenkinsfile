...
pipeline{
    ...
    parameters {
        ...
        string(name: 'gitUserConfigEmail', defaultValue: 'uman32247@gmail.com', description: 'Git User Email')
        string(name: 'gitUserName', defaultValue: 'UmaNagalla', description: 'Git User Name')
